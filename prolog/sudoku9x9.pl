...
pretty_print([]) :- nl.
pretty_print(Array) :-
    Array = [E1|[E2|[E3|[E4|[E5|[E6|[E7|[E8|[E9|Rest]]]]]]]]],
    write('['),
    write(E1), write(' '), write(E2), write(' '), write(E3), write(' '),
    write(E4), write(' '), write(E5), write(' '), write(E6), write(' '),
    write(E7), write(' '), write(E8), write(' '), write(E9), write(']'),
    nl,
    pretty_print(Rest).

% sudoku([9, 6, _, 1, _, 4, _, 5, _,
%         _, _, 8, 3, _, 5, 6, _, _,
%         2, _, _, _, _, _, _, _, 1,
%         8, _, _, 4, _, 7, _, _, 6,
%         _, _, 6, _, _, _, 3, _, _,
